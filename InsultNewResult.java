...
import package5.*;
import package7.*;
import package8.AllStudentResult;
public class InsertNewResult extends javax.swing.JFrame {
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        ...
        String PPS=jTextField5.getText();
        ...
        try
        {
            ...
            if(rs.next())
            {
                st.executeUpdate("Insert into result (rollNo,Physics,Chemistry,Maths,PPS,Electrical) values('"+rollNo+"','"+Physics+"','"+Chemistry+"','"+Maths+"','"+PPS+"','"+Electrical+"')");
